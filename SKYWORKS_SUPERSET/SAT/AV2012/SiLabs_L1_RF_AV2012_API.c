 ...
 *************************************************************************************************************/
/*************************************************************************************************************/
/*                     Skyworks Layer 1                  RF Tuner AV2012                                       */
/*-----------------------------------------------------------------------------------------------------------*/
...
/* Change log:
 ...
 As from SVN5293:
  ...
  <cleanup/blindscan> Removing auto_scan field from context, since this is not used with Skyworks demodulators.
 ...
 As from SVN4960:
  <improvement> [SW_Startup] In L1_RF_AV2012_Init: Checking i2c read result.
   ...
   NB: This is for SW startup purpose. It is not intended to be used as an automatic i2c address detection, since
      ...
      For instance, Skyworks TER tuners use the same i2c address range, and it could generate conflicts.
