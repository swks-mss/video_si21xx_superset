 ...
 *************************************************************************************************************/
/*************************************************************************************************************/
/*                     Skyworks Layer 1                  RF Tuner NXP20142_functions                                  */
/*-----------------------------------------------------------------------------------------------------------*/
...
/************************************************************************************************************************
  ...
  Behavior:   This function uses 2 sets of tables to return a linear estimation of the rssi
              ...
              Hint: The table values may need to be calibrated to match the HW design and any existing difference with the Skyworks EVBs.
