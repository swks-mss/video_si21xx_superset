 ...
 *************************************************************************************************************/
/*************************************************************************************************************/
/*                     Skyworks Layer 1                  RF Tuner RDA5815M_functions                         */
/*-----------------------------------------------------------------------------------------------------------*/
...
/*     WARNING: UNTESTED on HW by Skyworks (no available HW).                                                  */
/*************************************************************************************************************/
/* Change log:
 ...
 As from SVN5297: Modified to match latest RDA5815M sample code. Still UNTESTED on HW by Skyworks (no available HW).
