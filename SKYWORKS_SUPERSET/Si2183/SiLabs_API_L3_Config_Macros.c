...
/*                                  Skyworks API Configuration Macros                                        */
/*-----------------------------------------------------------------------------------------------------------*/
/*   This source code calls macros allowing easy initialization of Skyworks EVBs                             */
...
/* Last  changes:
 ...
 As from V2.3.9:
  ...
  As from V2.2.8:
   Initial version, with current Skyworks EVBs as from 2013/09/09
...
signed   int   SiLabs_SW_config_possibilities  (char *config_macros) {
  ...
  sprintf(config_macros,   "%s\n-----------Skyworks EVB Macros-------"      , config_macros);
