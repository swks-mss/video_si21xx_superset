...
/*                              Skyworks API Console Functions                                               */
/*-----------------------------------------------------------------------------------------------------------*/
/*   This source code contains all console functions for a Skyworks digital TV demodulator Evaluation board  */
/*************************************************************************************************************/
/* Change log:
...
----------------------------------------------------------------------------\n\
    This is a demonstration application used to illustrate how to use       \n\
       the Skyworks digital TV API delivered by Skyworks Solutions          \n\
                                                                            \n");
    printf("\
...
/************************************************************************************************************************
  NAME: Silabs_menu
  DESCRIPTION: Skyworks user menu function
