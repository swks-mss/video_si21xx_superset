 ...
 *************************************************************************************************************/
/***************************************************************************************
                  Skyworks Solutions Broadcast Si2151 Layer 3 API
...
/* If using a Skyworks Demod and > 1 tuner then undef both flags and define Si2151_DEMOD_WRAPPER_VCO (see Si2151_L2_API.c) */
...
/* To be able to test this on Skyworks demod EVB, it must be possible to close the i2c passthru in the demod */
...
----------------------------------------------------------------------------\n\
       This is a demonstration application used to illustrate how to use    \n\
            the Si2151 API delivered by Skyworks Solutions                \n\
                                                                            \n\
                                                                            \n\
                                                                            \n\
